...
?>
  ...
  <div class="form-card">
    <div class="form-container">
      ...
      <div class="form">
        <form method="post" action="<?php echo htmlspecialchars($action) ?>" novalidate>

          <div class="label-group">
            <label for="username">Username</label>
            <input type="text" id="username" name="login_username" class="input" value="<?php echo htmlspecialchars($sticky_login_username); ?>" required>
          </div>

          <div class="label-group">
            <label for="password">Password</label>
            <input type="password" id="password" name="login_password" class="input" required>
          </div>

          <input class="submit-button clickable" type="submit" value="Submit" name="login">

          <div class="notice">
            Only authorized users may login
          </div>
        </form>
      </div>
    </div>
